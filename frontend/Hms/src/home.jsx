      ...
      <main className="flex-grow container mx-auto py-10 px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white bg-opacity-80 p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600 mt-2">Add, remove, and update doctors, patients, and staff.</p>
            <button className="mt-4 px-4 py-2 text-black rounded hover:underline hover:underline-offset-2">
              See more...
            </button>
          </div>
          ...
          <div className="bg-white bg-opacity-80 p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600 mt-2">Monitor and manage hospital appointments.</p>
            <button className="mt-4 px-4 py-2 text-black rounded hover:underline hover:underline-offset-2">
              See more...
            </button>
          </div>
          ...
          <div className="bg-white bg-opacity-80 p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600 mt-2">Generate reports on hospital performance and earnings.</p>
            <button className="mt-4 px-4 py-2 text-black rounded hover:underline hover:underline-offset-2">
              See more...
            </button>
          </div>
